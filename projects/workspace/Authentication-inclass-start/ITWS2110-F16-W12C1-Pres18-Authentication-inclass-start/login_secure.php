...
// check user with the salt
  // ? $salt_stmt = $dbconn->prepare('SELECT username, uid, WHERE username=:username');
  ...
  $login_stmt = $dbconn->prepare('SELECT username, uid FROM users_secure WHERE username=:username AND ptpassword=:pass');
